  ...
  return (
    <div className="bg-[hsl(222,47%,9%)] border border-[hsl(215,20%,18%)] rounded-lg p-4 sm:p-6">
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-4 sm:mb-6">
        <div className="bg-[hsl(222,47%,7%)] rounded-lg p-3 sm:p-4 border border-[hsl(215,20%,18%)]/50">
          <p className="text-[10px] sm:text-xs text-[hsl(215,20%,55%)] uppercase tracking-wider">
            Total Exposure
          </p>
          <p className="font-mono text-base sm:text-xl font-bold text-white mt-1">
        ...
        <div className="bg-[hsl(222,47%,7%)] rounded-lg p-3 sm:p-4 border border-[hsl(215,20%,18%)]/50">
          ...
          <p className="font-mono text-base sm:text-xl font-bold text-red-400 mt-1">
            {formatUSD(maxLoss)}
          </p>
        </div>
      </div>
      ...
      <div className="-mx-4 sm:mx-0 overflow-x-auto">
        <div className="min-w-[550px] sm:min-w-0 px-4 sm:px-0">
            ...
            <tbody>
              {perps.map((perp) => (
                ...
                >
                  ...
                  <td
                    className={`py-3 text-right font-mono font-bold whitespace-nowrap ${leverageColor(
                      perp.leverage
                    )}`}
                  >
                    {perp.leverage}x
                  ...
                  <td className="py-3 text-right font-mono text-red-400 whitespace-nowrap">
                    {formatUSD(perp.stop)}
                  </td>
                </tr>
              ))}
