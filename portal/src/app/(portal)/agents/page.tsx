export default function AgentsPage() {
  const agents = [
    ...
    },
    {
      ...
      description:
        "Monitors governance forums, Snapshot votes, and on-chain parameter changes for every protocol in the portfolio. Flags fee switches, treasury movements, and upgrade proposals.",
      schedule: "Every 6 hours",
      cost: "~$0.05 / run",
      status: "planned",
      capabilities: [
        "Aave, Uniswap, Pendle governance tracking",
        "Snapshot vote alerts",
        "Fee switch and parameter change detection",
        "Treasury flow monitoring",
        "Delegate activity tracking",
      ],
      trigger: '"Thorin: watch" or /thorin',
    },
    {
      name: "Balin",
      role: "Risk Sentinel",
      description:
        "Watches fund wallet activity, monitors position stop losses, and recalculates risk scores. Alerts when positions approach exit triggers or concentration limits are breached.",
      schedule: "Every 4 hours",
      cost: "~$0.05 / run",
      status: "planned",
      capabilities: [
        "Wallet inflow/outflow monitoring",
        "Stop-loss distance tracking",
        "Risk score recalculation",
        "Concentration limit alerts",
        "Whale movement detection in held tokens",
      ],
      trigger: '"Balin: check" or /balin',
    },
    {
      name: "Gandalf",
